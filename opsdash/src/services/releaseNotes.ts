...
const RELEASE_NOTES: ReleaseNotesEntry[] = [
  {
    version: '0.8.1',
    date: '2026-05-10',
    title: 'Scheduled recap emails are now part of the dashboard flow',
    teaser: 'Opsdash can now turn your planning setup into real recap emails: weekly and monthly modes, local send times, a live test-send path, and goal-aware report layouts.',
    summary: 'Version 0.8.1 turns reporting into a real feature. You can configure weekly and monthly recaps in Preferences, send a test recap immediately, and let Nextcloud deliver scheduled reports that match your planning model.',
    highlights: [
